...
1. **Clone the repository:**
    ...
    git clone https://github.com/YourUsername/azure.git
    cd azure
...
Follow me on **LinkedIn** (https://www.linkedin.com/in/subbarayudu-nandyala/)  for updates and discussions about DevOps and Azure Cloud.
